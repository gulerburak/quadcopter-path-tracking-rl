...
<p align="center">
  <img src="assets/sim_circle.gif" width="400" alt="PyBullet simulation of the learned controller tracking a circle" />
  <img src="assets/sim_cube.gif" width="400" alt="PyBullet simulation of the learned controller tracking cube edges" />
</p>

PyBullet sim of the learned controller. Circle on the left, cube edges on the right. Grey is the reference, blue is the flown path, red is the active waypoint.
